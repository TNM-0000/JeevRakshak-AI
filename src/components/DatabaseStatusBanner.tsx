...
-- 2. Add multilingual support & metadata columns
...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS preferred_language text DEFAULT 'mr', ADD COLUMN IF NOT EXISTS email text, ADD COLUMN IF NOT EXISTS farm_name text, ADD COLUMN IF NOT EXISTS district text, ADD COLUMN IF NOT EXISTS block text, ADD COLUMN IF NOT EXISTS village text, ADD COLUMN IF NOT EXISTS state text DEFAULT 'Maharashtra', ADD COLUMN IF NOT EXISTS hospital_name text, ADD COLUMN IF NOT EXISTS facility_type text, ADD COLUMN IF NOT EXISTS license_number text, ADD COLUMN IF NOT EXISTS hospital_address text, ADD COLUMN IF NOT EXISTS hospital_lat double precision, ADD COLUMN IF NOT EXISTS hospital_lng double precision, ADD COLUMN IF NOT EXISTS hospital_pincode text, ADD COLUMN IF NOT EXISTS hospital_district text, ADD COLUMN IF NOT EXISTS hospital_block text, ADD COLUMN IF NOT EXISTS emergency_phone text;
...
ALTER TABLE animals ADD COLUMN IF NOT EXISTS name text, ADD COLUMN IF NOT EXISTS species_en text, ADD COLUMN IF NOT EXISTS species_hi text, ADD COLUMN IF NOT EXISTS species_mr text, ADD COLUMN IF NOT EXISTS breed_en text, ADD COLUMN IF NOT EXISTS breed_hi text, ADD COLUMN IF NOT EXISTS breed_mr text, ADD COLUMN IF NOT EXISTS is_milking boolean DEFAULT false, ADD COLUMN IF NOT EXISTS milking_status text, ADD COLUMN IF NOT EXISTS vaccination_status text DEFAULT 'not_vaccinated', ADD COLUMN IF NOT EXISTS notes text;
ALTER TABLE health_reports ADD COLUMN IF NOT EXISTS symptoms_en text, ADD COLUMN IF NOT EXISTS symptoms_hi text, ADD COLUMN IF NOT EXISTS symptoms_mr text, ADD COLUMN IF NOT EXISTS notes_en text, ADD COLUMN IF NOT EXISTS notes_hi text, ADD COLUMN IF NOT EXISTS notes_mr text;
ALTER TABLE case_assessments ADD COLUMN IF NOT EXISTS assessment_notes_en text, ADD COLUMN IF NOT EXISTS assessment_notes_hi text, ADD COLUMN IF NOT EXISTS assessment_notes_mr text;
ALTER TABLE animal_treatments ADD COLUMN IF NOT EXISTS treatment_name_en text, ADD COLUMN IF NOT EXISTS treatment_name_hi text, ADD COLUMN IF NOT EXISTS treatment_name_mr text, ADD COLUMN IF NOT EXISTS notes_en text, ADD COLUMN IF NOT EXISTS notes_hi text, ADD COLUMN IF NOT EXISTS notes_mr text;
ALTER TABLE animal_vaccinations ADD COLUMN IF NOT EXISTS vaccine_name_en text, ADD COLUMN IF NOT EXISTS vaccine_name_hi text, ADD COLUMN IF NOT EXISTS vaccine_name_mr text, ADD COLUMN IF NOT EXISTS notes_en text, ADD COLUMN IF NOT EXISTS notes_hi text, ADD COLUMN IF NOT EXISTS notes_mr text;
ALTER TABLE diagnostic_samples ADD COLUMN IF NOT EXISTS sample_type_en text, ADD COLUMN IF NOT EXISTS sample_type_hi text, ADD COLUMN IF NOT EXISTS sample_type_mr text, ADD COLUMN IF NOT EXISTS result_en text, ADD COLUMN IF NOT EXISTS result_hi text, ADD COLUMN IF NOT EXISTS result_mr text, ADD COLUMN IF NOT EXISTS notes_en text, ADD COLUMN IF NOT EXISTS notes_hi text, ADD COLUMN IF NOT EXISTS notes_mr text;
ALTER TABLE case_escalations ADD COLUMN IF NOT EXISTS reason_en text, ADD COLUMN IF NOT EXISTS reason_hi text, ADD COLUMN IF NOT EXISTS reason_mr text;
...
ALTER TABLE herd_health_events ADD COLUMN IF NOT EXISTS description_en text, ADD COLUMN IF NOT EXISTS description_hi text, ADD COLUMN IF NOT EXISTS description_mr text;
